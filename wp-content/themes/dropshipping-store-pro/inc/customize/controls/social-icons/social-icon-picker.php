...
class drop_shipping_pro_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="total-icon-list clearfix">
                    ...
                    <?php
                    $drop_shipping_pro_font_awesome_icon_array = drop_shipping_pro_font_awesome_icon_array();
                    foreach ($drop_shipping_pro_font_awesome_icon_array as $drop_shipping_pro_font_awesome_icon) {
                            $icon_class = $this->value() == $drop_shipping_pro_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($drop_shipping_pro_font_awesome_icon).'"></i>
                                <span class="vw-social-class">'.esc_attr($drop_shipping_pro_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function drop_shipping_pro_customizer_script() {
...
add_action( 'customize_controls_enqueue_scripts', 'drop_shipping_pro_customizer_script' );

if(!function_exists('drop_shipping_pro_font_awesome_icon_array')){
    function drop_shipping_pro_font_awesome_icon_array(){
