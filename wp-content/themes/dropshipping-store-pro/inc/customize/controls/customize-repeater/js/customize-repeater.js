jQuery( document ).ready(function($) {
	...
	$('.sortable_repeater_control').each(function() {
		...
		var defaultValuesArray = new Array("feature","our-product","all-category","product-banner1","product-category","deals","product-banner2","new-arrival","featured-blog","product-brands");
