...
$config['page_slug'] 	= 'dropshipping-store-pro';
$config['page_title']	= 'BWT Setup Wizard';
...
$config['steps'] = array( 
	'intro' => array(
		...
		'title'			=> __( 'Welcome to ', 'dropshipping-store-pro' ) . $theme_title, // Section title
		'icon'			=> 'dashboard', // Uses Dashicons
		'button_text'	=> __( 'Start Now', 'dropshipping-store-pro' ), // Button text
