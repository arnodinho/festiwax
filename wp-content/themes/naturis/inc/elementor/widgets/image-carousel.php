...
class Naturis_Image_Carousel extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'naturis-image-carousel';
    }

    public function get_title()
    {
        return __('Naturis Image Carousel', 'naturis');
    }
    ...
    public function get_script_depends() {
        return [ 'naturis-elementor-image-carousel', 'slick' ];
    }
...
$widgets_manager->register(new Naturis_Image_Carousel());
