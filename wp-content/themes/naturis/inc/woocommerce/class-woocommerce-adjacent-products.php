<?php
/**
 * naturis WooCommerce Adjacent Products Class
 *
 * @package  naturis
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Naturis_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The naturis WooCommerce Adjacent Products Class
	 */
	class Naturis_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'naturis_woocommerce_adjacent_query_args', $args ) );
