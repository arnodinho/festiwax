<?php
/**
 * Naturis_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        naturis_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Naturis_Product_Brand_List_Walker', false)) :

	class Naturis_Product_Brand_List_Walker extends Walker {
